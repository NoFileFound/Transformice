...
public class ByteArray {
    ...
    /**
     * ZLIB compression on bytearray.
     * @return A compressed packet using ZLIB.
     */
    public byte[] compressPacket() {
        Deflater deflater = new Deflater();
        deflater.setInput(this.toByteArray());
        deflater.finish();

        byte[] compressedData = new byte[this.buffer.size()];
